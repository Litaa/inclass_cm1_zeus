...
- Logistic Regression melakukan prediksi berdasarkan nilai _____
- Output dari model Logistic Regression adalah ____
- Nilai yang dapat di interpretasikan adalah ____
- Rentang dari masing-masing nilai di bawah ini adalah : 
  + Log of Odds: ___ s/d ___
  + Odds: ____ s/d ____
  + Probability: ___ s/d ___
- Apabila diketahui informasi sebagai berikut pada data credit: 
  ...
  + Bagaimana cara interpretasi untuk keduanya : 
    * interpretasi odds gagal bayar : _____
    * interpretasi odds berhasil bayar : _____
  + Dari hasil interpretasi, yang lebih sering terjadi adalah kasus gagal bayar atau berhasil bayar? ____
